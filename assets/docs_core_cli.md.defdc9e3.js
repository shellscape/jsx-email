import{_ as n,o as l,c as p,k as a,a as o,t as e,Q as t}from"./chunks/framework.fd95ed2e.js";const i="/preview-1.png",c="/preview-2.png",r="/preview-3.png",d="/preview-4.png",C=JSON.parse('{"title":"CLI","description":"The Command Line Interface and developer tooling for JSX email","frontmatter":{"title":"CLI","description":"The Command Line Interface and developer tooling for JSX email","slug":"cli","head":[["meta",{"name":"og:description","content":"The Command Line Interface and developer tooling for JSX email"}],["meta",{"name":"og:image","content":"https://jsx.email/og.png"}],["meta",{"name":"og:site_name","content":"JSX email"}],["meta",{"name":"og:title","content":"CLI"}],["meta",{"name":"og:type","content":"website"}],["meta",{"name":"twitter:card","content":"summary_large_image"}],["meta",{"name":"twitter:description","content":"The Command Line Interface and developer tooling for JSX email"}],["meta",{"name":"twitter:image","content":"https://jsx.email/og.png"}],["meta",{"name":"twitter:title","content":"CLI"}]]},"headers":[],"relativePath":"../../../docs/core/cli.md","filePath":"../../../docs/core/cli.md"}'),m={name:"../../../docs/core/cli.md"},h={id:"frontmatter-title",tabindex:"-1"},y=a("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),E=t(`<h2 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-label="Permalink to &quot;Installation&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki slack-dark vp-code-dark"><code><span class="line"><span style="color:#DCDCAA;">pnpm</span><span style="color:#E6E6E6;"> </span><span style="color:#CE9178;">add</span><span style="color:#E6E6E6;"> </span><span style="color:#CE9178;">@jsx-email/cli</span><span style="color:#E6E6E6;"> </span><span style="color:#CE9178;">-D</span></span>
...
<span class="line"><span style="color:#6A9955;"># bun add @jsx-email/cli -D</span></span>
...
<span class="line"><span style="color:#357B42;font-style:italic;"># bun add @jsx-email/cli -D</span></span>
...
<span class="line"><span style="color:#E6E6E6;">  --version   Displays the current @jsx-email/cli version</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#002339;">  --version   Displays the current @jsx-email/cli version</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#002339;">  $ email preview ./src/templates</span></span></code></pre></div><p>To view help for specific commands, use <code>email help &lt;command&gt;</code>. e.g. <code>email help build</code>.</p><h2 id="build" tabindex="-1">Build <a class="header-anchor" href="#build" aria-label="Permalink to &quot;Build&quot;">​</a></h2><p>The <code>build</code> command compiles and renders an email template to HTML for use with an email provider.</p><div class="language-console vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">console</span><pre class="shiki slack-dark vp-code-dark"><code><span class="line"><span style="color:#E6E6E6;">$ cd </span><span style="color:#D4D4D4;">~</span><span style="color:#E6E6E6;">/code/email-app</span></span>
...
<span class="line"><span style="color:#002339;">$ email build ./emails/Batman.tsx</span></span></code></pre></div><h3 id="client-compatibility-check" tabindex="-1">Client Compatibility Check <a class="header-anchor" href="#client-compatibility-check" aria-label="Permalink to &quot;Client Compatibility Check&quot;">​</a></h3><p>As part of the build process, <code>jsx-email</code> can run a client compatibility check on the ouput, comparing it to the compatibility tables from \`<a href="https://caniemail.com/" target="_blank" rel="noreferrer">caniuse.com</a> and display any email client compatibility issues. This check will not throw an error or block any pipelines, and is purely informative.</p><p>To enable this check, use the <code>--check</code> flag.</p><div class="language-console vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">console</span><pre class="shiki slack-dark vp-code-dark"><code><span class="line"><span style="color:#E6E6E6;">$ email build ./emails/Batman.tsx --check</span></span></code></pre><pre class="shiki slack-ochin vp-code-light"><code><span class="line"><span style="color:#002339;">$ email build ./emails/Batman.tsx --check</span></span></code></pre></div><h2 id="preview" tabindex="-1">Preview <a class="header-anchor" href="#preview" aria-label="Permalink to &quot;Preview&quot;">​</a></h2><p>JSX email ships with a Preview Tool as part of the CLI. Our Preview is fast, simple, and smooth. It doesn&#39;t require installing any crazy dependencies, downloading additional &quot;clients,&quot; or copying your project&#39;s dependencies. It just works. And the best part: it works with monorepos out of the box.</p><p>To use the Preview Tool, open your terminal and navigate to your project. We&#39;re assuming you&#39;ve already installed the CLI as shown above, and that you&#39;ve already run <code>email create</code> to create an email in an <code>emails</code> directory.</p><div class="language-console vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">console</span><pre class="shiki slack-dark vp-code-dark"><code><span class="line"><span style="color:#E6E6E6;">$ cd </span><span style="color:#D4D4D4;">~</span><span style="color:#E6E6E6;">/code/email-app</span></span>
