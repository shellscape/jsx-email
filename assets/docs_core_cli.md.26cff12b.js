...
<span class="line"><span style="color:#002339;">  $ email preview ./src/templates</span></span></code></pre></div><h2 id="build" tabindex="-1">Build <a class="header-anchor" href="#build" aria-label="Permalink to &quot;Build&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>To view info, flags, and options for the <code>build</code> command, run <code>email help build</code>.</p></div><p>The <code>build</code> command compiles and renders an email template to HTML for use with an email provider. The command takes a directory or single file as input:</p><div class="language-console vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">console</span><pre class="shiki slack-dark vp-code-dark"><code><span class="line"><span style="color:#E6E6E6;">$ cd </span><span style="color:#D4D4D4;">~</span><span style="color:#E6E6E6;">/code/email-app</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#002339;">Check Complete: 14 error(s), 20 warning(s)</span></span></code></pre></div><h2 id="preview" tabindex="-1">Preview <a class="header-anchor" href="#preview" aria-label="Permalink to &quot;Preview&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>To view info, flags, and options for the <code>preview</code> command, run <code>email help preview</code>.</p></div><p>JSX email ships with a Preview Tool as part of the CLI. Our Preview is fast, simple, and smooth. It doesn&#39;t require installing any crazy dependencies, downloading additional &quot;clients,&quot; or copying your project&#39;s dependencies. It just works. And the best part: it works with monorepos out of the box.</p><p>The preview also supports static local assets. For a good example of how to handle local assets like images, please have a look at <a href="https://github.com/shellscape/jsx-email/blob/main/apps/demo/emails/airbnb-review.tsx" target="_blank" rel="noreferrer">the demo AirBnB template</a>. Notice that <code>baseUrl</code> is set using a condition on <code>i<wbr>mport.meta.isJsxEmailPreview</code>. That <code>i<wbr>mport.meta</code> property is specific to <code>jsx-email</code> and will be replaced appropriately at build time. Local assets are served from the templates root directory, in this case <code>apps/demos/emails</code>, at the server root. So a <code>apps/demos/emails/batman.png</code> file would be served at <code>/batman.png</code> in the browser. We recommend using a <code>static</code> or <code>assets</code> directory in your templates root directory, so it&#39;s clear where files are being served from when viewing in the Preview Tool.</p><p>To use the Preview Tool, open your terminal and navigate to your project. We&#39;re assuming you&#39;ve already installed the CLI as shown above, and that you&#39;ve already run <code>email create</code> to create an email in an <code>emails</code> directory.</p><div class="language-console vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">console</span><pre class="shiki slack-dark vp-code-dark"><code><span class="line"><span style="color:#E6E6E6;">$ cd </span><span style="color:#D4D4D4;">~</span><span style="color:#E6E6E6;">/code/email-app</span></span>
