...
type: component
copyPrompt: Use inside `Row` for vertical content areas in a horizontal layout. Set widths deliberately and keep children simple so table rendering stays predictable.
---
