...
type: component
copyPrompt: Use for short syntax-highlighted snippets. Keep code concise, avoid oversized blocks, and style surrounding content so the snippet remains readable in narrow clients.
---
