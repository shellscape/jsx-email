...
type: component
copyPrompt: Use for CTA links, not form actions. Always provide a real `href`, clear label text, dimensions or padding, and simple styles that survive Outlook.
---
