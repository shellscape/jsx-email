...
type: component
copyPrompt: Use only for trusted provider templating or raw HTML fragments. Content is unescaped, so never pass user input and keep opening/closing fragments balanced.
---
