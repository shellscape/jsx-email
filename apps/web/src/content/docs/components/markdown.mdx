...
type: component
copyPrompt: Use for trusted markdown content inside an email. Do not pass unsanitized user input, and keep custom markdown styles sparse because they override defaults.
---
