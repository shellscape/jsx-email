...
type: component
copyPrompt: Place inside `Head` to declare color-scheme support. Choose `mode` deliberately and do not rely on it alone for dark-mode correctness across clients.
---
...
<Callout type="info" title="Tips">
  Please be sure to read our FAQ about Dark Mode in the context of email templates:
  https://jsx.email/docs/faq#dark-and-light-mode
</Callout>
