...
<Tabs syncKey="install">
  <TabItem label="pnpm">```sh pnpm add jsx-email ```</TabItem>
  <TabItem label="npm">```sh npm install jsx-email ```</TabItem>
  <TabItem label="yarn">```sh yarn add jsx-email ```</TabItem>
  <TabItem label="bun">```sh bun add jsx-email ```</TabItem>
</Tabs>
