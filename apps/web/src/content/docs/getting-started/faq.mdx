...
Can I deploy my own preview app? Absolutely! The CLI has the ability to build a custom, deployable preview app using your templates. Please see [the documentation](/core/cli#deploying-your-preview-app) for more information.
