...
export function Header() {
  ...
  useEffect(() => {
    let active = true;
    fetch('https://api.github.com/repos/shellscape/jsx-email')
      ...
      .then((data) => {
        ...
        setStars(
          new Intl.NumberFormat('en-US', {
            ...
            notation: data.stargazers_count >= 1000 ? 'compact' : 'standard'
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-[var(--border)] bg-white/90 backdrop-blur-sm dark:bg-black/90">
      <div className="container mx-auto flex items-center justify-between px-4 py-4 md:px-6">
        <a
          aria-label="JSX email home"
          className="inline-flex min-h-10 w-[220px] max-w-full cursor-pointer items-center text-black dark:text-white"
          href="/"
        >
          <LogoWordmark />
        </a>
          ...
          {[
            ...
            >
              ...
              {href.startsWith('http') && (
                <Svg className="ml-1 inline-block h-3 w-3" viewBox="0 0 12 12">
                  <path
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            target="_blank"
          >
            <Svg className="h-5 w-5 flex-shrink-0" viewBox="0 0 71 55">
              <path
          ...
          <a
            ...
            className="flex items-center justify-center gap-1.5 rounded-md p-1.5 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-300"
          ...
          >
            ...
            {stars && <span className="text-xs font-medium">{stars}</span>}
          </a>
        </div>
      </div>
    </header>
