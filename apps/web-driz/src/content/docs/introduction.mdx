...
<div>
  ...
  email templates, compatible with modern email clients. Our components handle the heavy lifting of
  compatibility and client inconsistency so designers and developers can focus on building impactful
  and engaging templates.
</div>
