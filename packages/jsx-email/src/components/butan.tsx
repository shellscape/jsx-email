...
export const Butan: JsxEmailComponent<ButanProps> = ({ children, style, target, ...props }) => {
  log.warn(
    `The Butan component is deprecated and is provided as a means of migrating to the updated Butan component. It'll be removed in the next major version.`
  );
