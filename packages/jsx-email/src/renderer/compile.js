...
import { dirname, basename, extname, join, resolve, isAbsolute, normalize, posix, win32 } from 'node:path';
...
export const resolveOutputPath = (outDir, outKey, cwd = originalCwd) => {
