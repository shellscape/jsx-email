...
[`@jsx-email/head` Documentation](https://jsx.email/docs/components/head)
...
Please see the [`@jsx-email/head` Documentation](https://jsx.email/docs/components/head) for props and additional usage information.
